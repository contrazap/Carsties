...
public class AuctionControllerTests : IAsyncLifetime
{
    ...
    {
        // arrange
        var auction = new UpdateAuctionDto { Make = "make updated" };
        _httpClient.SetFakeJwtBearerToken(AuthHelper.GetBearerForUser("bob"));

        // act
        var response = await _httpClient.PutAsJsonAsync("api/auctions/afbee524-5972-4075-8800-7d1f9d7b0a0c", auction);
